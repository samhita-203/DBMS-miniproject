...
class Application:
    ...
    def search_db(self):
        ...
        for self.row in self.res:
            ...
            self.scheduled_time = self.row[6]
        ...
        self.uscheduled_time = Label(self.master, text="Scheduled Time", font=('arial 18 bold'))
        self.uscheduled_time.place(x=0, y=340)
        ...
        self.ent6.insert(END, str(self.scheduled_time))
